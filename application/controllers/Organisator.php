...
class Organisator extends CI_Controller {
    ...
    public function stuurTestMail(){
        $this->stuurMail('Test mail met link', 'Dit is een test bericht <br/> nieuwe lijn', 'jenssels1998@gmail.com', 'personeel', '6xkY28eLg9ho1tfu', true);
    }
    public function stuurMail($titel,$message,$mail,$type,$hash, $isInschrijfLink = false){
        ...
        if ($isInschrijfLink){
            ...
            $message .= '<br /> Gebruik onderstaande link om u keuzes voor het personeelsfeest op te geven: <br /> ' . $link;
        }
